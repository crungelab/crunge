...
class PrimitiveBuilder(ModelBuilder):
    def __init__(self, context: BuilderContext, mesh: Mesh, tf_primitive: gltf.Primitive) -> None:
    ...
    def build_material(self):
        ...
        material = self.tf_model.materials[tf_primitive.material]
        debug_material(material)
        self.material = MaterialBuilder(self.context, material).build()
        # exit()
