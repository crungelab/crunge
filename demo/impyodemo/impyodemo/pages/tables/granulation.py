...
class Granulation(Page):
    ...
    def do_setup(self):
        ...
        self.comp = Compress(grn, thresh=-20, ratio=4, risetime=0.005, falltime=0.10, knee=0.5, mul=2)
