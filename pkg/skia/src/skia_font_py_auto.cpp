...
void init_skia_font_py_auto(py::module &_skia, Registry &registry) {
    ...
    registry.on(_skia, "Font", _Font);
        ...
        .def("measure_text", py::overload_cast<const void *, size_t, SkTextEncoding, SkRect *, const SkPaint *>(&SkFont::measureText, py::const_)
            ...
            , py::arg("paint")
            , py::return_value_policy::automatic_reference)
        .def("get_widths", py::overload_cast<const SkGlyphID[], int, SkScalar[], SkRect[]>(&SkFont::getWidths, py::const_)
            , py::arg("glyphs")
            , py::arg("count")
            , py::arg("widths")
            , py::arg("bounds")
            , py::return_value_policy::automatic_reference)
        .def("get_widths", py::overload_cast<const SkGlyphID[], int, SkScalar[], std::nullptr_t>(&SkFont::getWidths, py::const_)
            , py::arg("glyphs")
            , py::arg("count")
            , py::arg("widths")
            , py::arg("arg")
            , py::return_value_policy::automatic_reference)
        .def("get_widths", py::overload_cast<const SkGlyphID[], int, SkScalar[]>(&SkFont::getWidths, py::const_)
            , py::arg("glyphs")
            , py::arg("count")
            , py::arg("widths")
            , py::return_value_policy::automatic_reference)
