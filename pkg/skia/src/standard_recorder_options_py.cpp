 ...
 */
 ...
 class StandardImageProvider : public skgpu::graphite::ImageProvider {
 public:
     StandardImageProvider() : fCache(kDefaultNumCachedImages) {}
     ~StandardImageProvider() override {}
 ...
 skgpu::graphite::RecorderOptions CreateStandardRecorderOptions() {
     skgpu::graphite::RecorderOptions options;
 
     options.fImageProvider.reset(new StandardImageProvider);
 
     return options;
 }
 
 void init_skia_standard_recorder_options_py(py::module &_skia, Registry &registry) {
    _skia.def("create_standard_recorder_options", &CreateStandardRecorderOptions);
}
