...
void init_skia_canvas_py_auto(py::module &_skia, Registry &registry) {
    ...
    registry.on(_skia, "Canvas", _Canvas);
        ...
        .def("clip_shader", &SkCanvas::clipShader
            , py::arg("arg")
            , py::arg("arg") = SkClipOp::kIntersect
            , py::return_value_policy::automatic_reference)
        ...
        .def("draw_string", py::overload_cast<const SkString &, SkScalar, SkScalar, const SkFont &, const SkPaint &>(&SkCanvas::drawString)
            ...
            , py::arg("paint")
            , py::return_value_policy::automatic_reference)
        .def("draw_glyphs", py::overload_cast<int, const SkGlyphID[], const SkPoint[], const uint32_t[], int, const char[], SkPoint, const SkFont &, const SkPaint &>(&SkCanvas::drawGlyphs)
            , py::arg("count")
            , py::arg("glyphs")
            , py::arg("positions")
            , py::arg("clusters")
            ...
            , py::arg("paint")
            , py::return_value_policy::automatic_reference)
        .def("draw_glyphs", py::overload_cast<int, const SkGlyphID[], const SkPoint[], SkPoint, const SkFont &, const SkPaint &>(&SkCanvas::drawGlyphs)
            , py::arg("count")
            , py::arg("glyphs")
            , py::arg("positions")
            , py::arg("origin")
            ...
            , py::arg("paint")
            , py::return_value_policy::automatic_reference)
        .def("draw_glyphs", py::overload_cast<int, const SkGlyphID[], const SkRSXform[], SkPoint, const SkFont &, const SkPaint &>(&SkCanvas::drawGlyphs)
            , py::arg("count")
            , py::arg("glyphs")
            , py::arg("xforms")
            , py::arg("origin")
