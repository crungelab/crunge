...
void init_skia_color_type_py_auto(py::module &_skia, Registry &registry) {
    py::enum_<SkColorType>(_skia, "ColorType", py::arithmetic())
        ...
        .value("K_RGB_F16F16F16X_SK_COLOR_TYPE", SkColorType::kRGB_F16F16F16x_SkColorType)
        .value("K_RGBA_F32_SK_COLOR_TYPE", SkColorType::kRGBA_F32_SkColorType)
        .value("K_R8G8_UNORM_SK_COLOR_TYPE", SkColorType::kR8G8_unorm_SkColorType)
        .value("K_A16_FLOAT_SK_COLOR_TYPE", SkColorType::kA16_float_SkColorType)
        .value("K_R16G16_FLOAT_SK_COLOR_TYPE", SkColorType::kR16G16_float_SkColorType)
        .value("K_A16_UNORM_SK_COLOR_TYPE", SkColorType::kA16_unorm_SkColorType)
        .value("K_R16G16_UNORM_SK_COLOR_TYPE", SkColorType::kR16G16_unorm_SkColorType)
        .value("K_R16G16B16A16_UNORM_SK_COLOR_TYPE", SkColorType::kR16G16B16A16_unorm_SkColorType)
