...
void init_main(py::module &_wgpu, Registry &registry) {
    ...
    /*
    py::bind_vector<BindGroupLayouts>(_wgpu, "BindGroupLayouts", "BindGroupLayout Vector");
    ...
    py::bind_vector<ColorTargetStates>(_wgpu, "ColorTargetStates", "ColorTargetState Vector");
    py::bind_vector<VertexBufferLayouts>(_wgpu, "VertexBufferLayouts", "VertexBufferLayout Vector");
    py::bind_vector<RenderPassColorAttachments>(_wgpu, "RenderPassColorAttachments", "RenderPassColorAttachment Vector");
    */
