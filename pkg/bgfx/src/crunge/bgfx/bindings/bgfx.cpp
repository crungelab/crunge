...
void init_bgfx(py::module &_bgfx, Registry &registry) {
        py::enum_<bgfx::Fatal::Enum>(_bgfx, "Fatal", py::arithmetic())
        ...
        py::enum_<bgfx::RendererType::Enum>(_bgfx, "RendererType", py::arithmetic())
            .value("NOOP", bgfx::RendererType::Enum::Noop)
            .value("AGC", bgfx::RendererType::Enum::Agc)
        ...
        py::enum_<bgfx::Access::Enum>(_bgfx, "Access", py::arithmetic())
        ...
        py::enum_<bgfx::Attrib::Enum>(_bgfx, "Attrib", py::arithmetic())
        ...
        py::enum_<bgfx::AttribType::Enum>(_bgfx, "AttribType", py::arithmetic())
        ...
        py::enum_<bgfx::TextureFormat::Enum>(_bgfx, "TextureFormat", py::arithmetic())
            ...
            .value("ASTC5X4", bgfx::TextureFormat::Enum::ASTC5x4)
            .value("ASTC5X5", bgfx::TextureFormat::Enum::ASTC5x5)
            .value("ASTC6X5", bgfx::TextureFormat::Enum::ASTC6x5)
            ...
            .value("ASTC8X8", bgfx::TextureFormat::Enum::ASTC8x8)
            .value("ASTC10X5", bgfx::TextureFormat::Enum::ASTC10x5)
            .value("ASTC10X6", bgfx::TextureFormat::Enum::ASTC10x6)
            .value("ASTC10X8", bgfx::TextureFormat::Enum::ASTC10x8)
            .value("ASTC10X10", bgfx::TextureFormat::Enum::ASTC10x10)
            .value("ASTC12X10", bgfx::TextureFormat::Enum::ASTC12x10)
            .value("ASTC12X12", bgfx::TextureFormat::Enum::ASTC12x12)
            ...
            .value("B5G6R5", bgfx::TextureFormat::Enum::B5G6R5)
            .value("R5G6B5", bgfx::TextureFormat::Enum::R5G6B5)
            .value("BGRA4", bgfx::TextureFormat::Enum::BGRA4)
            .value("RGBA4", bgfx::TextureFormat::Enum::RGBA4)
            .value("BGR5A1", bgfx::TextureFormat::Enum::BGR5A1)
        ...
        py::enum_<bgfx::UniformType::Enum>(_bgfx, "UniformType", py::arithmetic())
        ...
        py::enum_<bgfx::BackbufferRatio::Enum>(_bgfx, "BackbufferRatio", py::arithmetic())
        ...
        py::enum_<bgfx::OcclusionQueryResult::Enum>(_bgfx, "OcclusionQueryResult", py::arithmetic())
        ...
        py::enum_<bgfx::Topology::Enum>(_bgfx, "Topology", py::arithmetic())
        ...
        py::enum_<bgfx::TopologyConvert::Enum>(_bgfx, "TopologyConvert", py::arithmetic())
        ...
        py::enum_<bgfx::TopologySort::Enum>(_bgfx, "TopologySort", py::arithmetic())
        ...
        py::enum_<bgfx::ViewMode::Enum>(_bgfx, "ViewMode", py::arithmetic())
    ...
    PYCLASS_BEGIN(_bgfx, bgfx::ViewStats, ViewStats)
        ...
        ViewStats.def_readwrite("gpu_frame_num", &bgfx::ViewStats::gpuFrameNum);
    ...
    PYCLASS_BEGIN(_bgfx, bgfx::Stats, Stats)
        ...
        Stats.def_readwrite("gpu_frame_num", &bgfx::Stats::gpuFrameNum);
    ...
    PYCLASS_END(_bgfx, bgfx::VertexLayout, VertexLayout)

    _bgfx.def("vertex_unpack", [](std::array<float, 4>& _output, Attrib::Enum _attr, const bgfx::VertexLayout & _layout, const void * _data, uint32_t _index)
    {
    ...
    _bgfx.def("create_texture2d", py::overload_cast<uint16_t, uint16_t, bool, uint16_t, TextureFormat::Enum, uint64_t, const bgfx::Memory *>(&bgfx::createTexture2D)
    , py::arg("_width")
    , py::arg("_height")
    , py::arg("_has_mips")
    , py::arg("_num_layers")
    ...
    _bgfx.def("create_texture2d", py::overload_cast<BackbufferRatio::Enum, bool, uint16_t, TextureFormat::Enum, uint64_t>(&bgfx::createTexture2D)
    , py::arg("_ratio")
    , py::arg("_has_mips")
    , py::arg("_num_layers")
    , py::arg("_format")
    ...
    _bgfx.def("create_texture3d", &bgfx::createTexture3D
    , py::arg("_width")
    , py::arg("_height")
    , py::arg("_depth")
    , py::arg("_has_mips")
    ...
    _bgfx.def("update_texture2d", &bgfx::updateTexture2D
    , py::arg("_handle")
    , py::arg("_layer")
    , py::arg("_mip")
    , py::arg("_x")
    ...
    _bgfx.def("update_texture3d", &bgfx::updateTexture3D
    , py::arg("_handle")
    , py::arg("_mip")
    , py::arg("_x")
    , py::arg("_y")
