...
void init_generated(py::module &_imgui, Registry &registry) {
    ...
    py::enum_<ImGuiWindowFlags_>(_imgui, "WindowFlags", py::arithmetic())
        ...
        .value("ALWAYS_USE_WINDOW_PADDING", ImGuiWindowFlags_::ImGuiWindowFlags_AlwaysUseWindowPadding)
        ...
        .value("NAV_FLATTENED", ImGuiWindowFlags_::ImGuiWindowFlags_NavFlattened)
    ...
    py::enum_<ImGuiSelectableFlags_>(_imgui, "SelectableFlags", py::arithmetic())
        ...
        .value("DONT_CLOSE_POPUPS", ImGuiSelectableFlags_::ImGuiSelectableFlags_DontClosePopups)
    ...
    py::enum_<ImGuiDragDropFlags_>(_imgui, "DragDropFlags", py::arithmetic())
        ...
        .value("SOURCE_AUTO_EXPIRE_PAYLOAD", ImGuiDragDropFlags_::ImGuiDragDropFlags_SourceAutoExpirePayload)
    ...
    py::enum_<ImGuiDir_>(_imgui, "Dir", py::arithmetic())
        ...
        .value("COUNT", ImGuiDir_::ImGuiDir_COUNT)
        .export_values();
    py::enum_<ImGuiSortDirection_>(_imgui, "SortDirection", py::arithmetic())
        .value("NONE", ImGuiSortDirection_::ImGuiSortDirection_None)
        .value("ASCENDING", ImGuiSortDirection_::ImGuiSortDirection_Ascending)
        .value("DESCENDING", ImGuiSortDirection_::ImGuiSortDirection_Descending)
        .export_values();
    ...
    py::enum_<ImGuiCol_>(_imgui, "Col", py::arithmetic())
        ...
        .value("TAB_ACTIVE", ImGuiCol_::ImGuiCol_TabActive)
        .value("TAB_UNFOCUSED", ImGuiCol_::ImGuiCol_TabUnfocused)
        .value("TAB_UNFOCUSED_ACTIVE", ImGuiCol_::ImGuiCol_TabUnfocusedActive)
    ...
    py::enum_<ImGuiButtonFlags_>(_imgui, "ButtonFlags", py::arithmetic())
        ...
        .value("MOUSE_BUTTON_DEFAULT", ImGuiButtonFlags_::ImGuiButtonFlags_MouseButtonDefault_)
        .export_values();
