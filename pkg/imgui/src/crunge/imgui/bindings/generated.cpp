...
void init_generated(py::module &_imgui, Registry &registry) {
    ...
    TreeNodeFlags
        ...
        .value("TREE_NODE_FLAGS_ALLOW_ITEM_OVERLAP", ImGuiTreeNodeFlags_::ImGuiTreeNodeFlags_AllowItemOverlap)
    ...
    SelectableFlags
        ...
        .value("SELECTABLE_FLAGS_ALLOW_ITEM_OVERLAP", ImGuiSelectableFlags_::ImGuiSelectableFlags_AllowItemOverlap)
        .export_values();
    ...
    DockNodeFlags
        ...
        .value("DOCK_NODE_FLAGS_NO_DOCKING_IN_CENTRAL_NODE", ImGuiDockNodeFlags_::ImGuiDockNodeFlags_NoDockingInCentralNode)
        .value("DOCK_NODE_FLAGS_PASSTHRU_CENTRAL_NODE", ImGuiDockNodeFlags_::ImGuiDockNodeFlags_PassthruCentralNode)
        .value("DOCK_NODE_FLAGS_NO_SPLIT", ImGuiDockNodeFlags_::ImGuiDockNodeFlags_NoSplit)
    ...
    ViewportFlags
        ...
        .value("VIEWPORT_FLAGS_MINIMIZED", ImGuiViewportFlags_::ImGuiViewportFlags_Minimized)
