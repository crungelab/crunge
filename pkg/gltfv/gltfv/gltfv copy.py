...
class HelloWgpu:
    ...
    def create_scene(self):
        ...
        #self.mesh = mesh = tm.load(str(scene_path))
        self.scene = scene = tm.load(str(scene_path))
        print(scene.__dict__)
        print(scene.graph.__dict__)
        print(scene.graph.transforms.edge_data)
        print(scene.graph.transforms.node_data)
        #print(scene)
