...
void init_generated(py::module &_imnodes, Registry &registry) {
    py::enum_<ImNodesCol_>(_imnodes, "Col", py::arithmetic())
        ...
        .value("COL_GRID_LINE_PRIMARY", ImNodesCol_GridLinePrimary)
    ...
    py::enum_<ImNodesStyleFlags_>(_imnodes, "StyleFlags", py::arithmetic())
        ...
        .value("STYLE_FLAGS_GRID_LINES_PRIMARY", ImNodesStyleFlags_GridLinesPrimary)
        .value("STYLE_FLAGS_GRID_SNAPPING", ImNodesStyleFlags_GridSnapping)
        .export_values();
