...
void init_generated(py::module &_imnodes, Registry &registry) {
    ...
    _imnodes.def("push_style_var", py::overload_cast<int, float>(&ImNodes::PushStyleVar)
        , py::arg("style_item")
        , py::arg("value")
        , py::return_value_policy::automatic_reference);
    ...
    _imnodes.def("save_current_editor_state_to_ini_string", [](unsigned long * data_size)
    {
    ...
    _imnodes.def("save_editor_state_to_ini_string", [](const ImNodesEditorContext * editor, unsigned long * data_size)
    {
