...
void init_sdl_video(py::module &_sdl, Registry &registry) {
    ...
    py::enum_<SDL_GLContextResetNotification>(_sdl, "GLContextResetNotification", py::arithmetic())
        ...
        .export_values();
    _sdl.def("get_num_video_drivers", &SDL_GetNumVideoDrivers
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_video_driver", &SDL_GetVideoDriver
        , py::arg("index")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_current_video_driver", &SDL_GetCurrentVideoDriver
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_system_theme", &SDL_GetSystemTheme
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_displays", [](int * count)
    {
    ...
    _sdl.def("get_primary_display", &SDL_GetPrimaryDisplay
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_display_properties", &SDL_GetDisplayProperties
        , py::arg("display_id")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_display_name", &SDL_GetDisplayName
        , py::arg("display_id")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_display_bounds", &SDL_GetDisplayBounds
        , py::arg("display_id")
        , py::arg("rect")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_display_usable_bounds", &SDL_GetDisplayUsableBounds
        , py::arg("display_id")
        , py::arg("rect")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_natural_display_orientation", &SDL_GetNaturalDisplayOrientation
        , py::arg("display_id")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_current_display_orientation", &SDL_GetCurrentDisplayOrientation
        , py::arg("display_id")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_display_content_scale", &SDL_GetDisplayContentScale
        , py::arg("display_id")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_closest_fullscreen_display_mode", &SDL_GetClosestFullscreenDisplayMode
        , py::arg("display_id")
        , py::arg("w")
        , py::arg("h")
        , py::arg("refresh_rate")
    ...
    _sdl.def("get_current_display_mode", &SDL_GetCurrentDisplayMode
        , py::arg("display_id")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_display_for_point", &SDL_GetDisplayForPoint
        , py::arg("point")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_display_for_rect", &SDL_GetDisplayForRect
        , py::arg("rect")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("get_display_for_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("get_window_pixel_density", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("get_window_display_scale", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("set_window_fullscreen_mode", [](SDLWindowWrapper * window, const SDL_DisplayMode * mode)
    {
    ...
    _sdl.def("get_window_fullscreen_mode", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("get_window_pixel_format", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("get_window_id", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("get_window_parent", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("get_window_properties", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("get_window_flags", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("set_window_title", [](SDLWindowWrapper * window, const char * title)
    {
    ...
    _sdl.def("get_window_title", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("set_window_icon", [](SDLWindowWrapper * window, SDL_Surface * icon)
    {
    ...
    _sdl.def("set_window_position", [](SDLWindowWrapper * window, int x, int y)
    {
    ...
    _sdl.def("get_window_position", [](SDLWindowWrapper * window, int * x, int * y)
    {
    ...
    _sdl.def("set_window_size", [](SDLWindowWrapper * window, int w, int h)
    {
    ...
    _sdl.def("get_window_minimum_size", [](SDLWindowWrapper * window, int * w, int * h)
    {
    ...
    _sdl.def("set_window_maximum_size", [](SDLWindowWrapper * window, int max_w, int max_h)
    {
    ...
    _sdl.def("get_window_maximum_size", [](SDLWindowWrapper * window, int * w, int * h)
    {
    ...
    _sdl.def("set_window_bordered", [](SDLWindowWrapper * window, bool bordered)
    {
    ...
    _sdl.def("set_window_resizable", [](SDLWindowWrapper * window, bool resizable)
    {
    ...
    _sdl.def("set_window_always_on_top", [](SDLWindowWrapper * window, bool on_top)
    {
    ...
    _sdl.def("show_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("hide_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("raise_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("maximize_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("minimize_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("restore_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("set_window_fullscreen", [](SDLWindowWrapper * window, bool fullscreen)
    {
    ...
    _sdl.def("sync_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("get_window_surface", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("update_window_surface_rects", [](SDLWindowWrapper * window, const SDL_Rect * rects, int numrects)
    {
    ...
    _sdl.def("destroy_window_surface", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("set_window_keyboard_grab", [](SDLWindowWrapper * window, bool grabbed)
    {
    ...
    _sdl.def("set_window_mouse_grab", [](SDLWindowWrapper * window, bool grabbed)
    {
    ...
    _sdl.def("get_window_mouse_grab", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("set_window_mouse_rect", [](SDLWindowWrapper * window, const SDL_Rect * rect)
    {
    ...
    _sdl.def("get_window_mouse_rect", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("set_window_opacity", [](SDLWindowWrapper * window, float opacity)
    {
    ...
    _sdl.def("set_window_parent", [](SDLWindowWrapper * window, SDLWindowWrapper * parent)
    {
    ...
    _sdl.def("set_window_modal", [](SDLWindowWrapper * window, bool modal)
    {
    ...
    _sdl.def("set_window_focusable", [](SDLWindowWrapper * window, bool focusable)
    {
    ...
    _sdl.def("show_window_system_menu", [](SDLWindowWrapper * window, int x, int y)
    {
    ...
    _sdl.def("destroy_window", [](SDLWindowWrapper * window)
    {
    ...
    _sdl.def("screen_saver_enabled", &SDL_ScreenSaverEnabled
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("enable_screen_saver", &SDL_EnableScreenSaver
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("disable_screen_saver", &SDL_DisableScreenSaver
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("gl_load_library", &SDL_GL_LoadLibrary
        , py::arg("path")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("gl_unload_library", &SDL_GL_UnloadLibrary
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("gl_extension_supported", &SDL_GL_ExtensionSupported
        , py::arg("extension")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("gl_reset_attributes", &SDL_GL_ResetAttributes
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("gl_set_attribute", &SDL_GL_SetAttribute
        , py::arg("attr")
        , py::arg("value")
        , py::return_value_policy::automatic_reference);
        
    _sdl.def("gl_get_attribute", [](SDL_GLattr attr, int * value)
    {
    ...
    _sdl.def("gl_get_swap_interval", [](int * interval)
    {
    ...
    _sdl.def("gl_swap_window", [](SDLWindowWrapper * window)
    {
