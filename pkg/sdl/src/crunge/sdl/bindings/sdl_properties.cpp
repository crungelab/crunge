...
void init_sdl_properties(py::module &_sdl, Registry &registry) {
    ...
    _sdl.def("get_global_properties", &SDL_GetGlobalProperties
    ...
    _sdl.def("set_string_property", &SDL_SetStringProperty
    , py::arg("props")
    , py::arg("name")
    , py::arg("value")
    , py::return_value_policy::automatic_reference);

    _sdl.def("set_number_property", &SDL_SetNumberProperty
    , py::arg("props")
    , py::arg("name")
    , py::arg("value")
    , py::return_value_policy::automatic_reference);

    _sdl.def("set_float_property", &SDL_SetFloatProperty
    , py::arg("props")
    , py::arg("name")
    , py::arg("value")
    , py::return_value_policy::automatic_reference);

    _sdl.def("set_boolean_property", &SDL_SetBooleanProperty
    , py::arg("props")
    , py::arg("name")
    , py::arg("value")
    , py::return_value_policy::automatic_reference);
    ...
    _sdl.def("get_string_property", &SDL_GetStringProperty
    , py::arg("props")
    , py::arg("name")
    , py::arg("default_value")
    , py::return_value_policy::automatic_reference);

    _sdl.def("get_number_property", &SDL_GetNumberProperty
    , py::arg("props")
    , py::arg("name")
    , py::arg("default_value")
    , py::return_value_policy::automatic_reference);

    _sdl.def("get_float_property", &SDL_GetFloatProperty
    , py::arg("props")
    , py::arg("name")
    , py::arg("default_value")
    , py::return_value_policy::automatic_reference);

    _sdl.def("get_boolean_property", &SDL_GetBooleanProperty
    , py::arg("props")
    , py::arg("name")
    , py::arg("default_value")
    , py::return_value_policy::automatic_reference);
