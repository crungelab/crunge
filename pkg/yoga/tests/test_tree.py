...
def main():
    ...
    child0_layout = child0.get_computed_layout()
    child0_left = child0_layout.left
    child0_top = child0_layout.top
    child0_width = child0_layout.width
    child0_height = child0_layout.height

    print(f"Child 0 Layout: Left={child0_left}, Top={child0_top}, Width={child0_width}, Height={child0_height}")

    child1_layout = child1.get_computed_layout()
    child1_left = child1_layout.left
    child1_top = child1_layout.top
    child1_width = child1_layout.width
    child1_height = child1_layout.height
