...
void init_yoga_layout_node_py(py::module &, Registry& registry);
void init_yoga_layout_node_py_auto(py::module &, Registry& registry);
...
PYBIND11_MODULE(_yoga, m) {
    ...
    init_yoga_layout_node_py(m, r);
    init_yoga_layout_node_py_auto(m, r);
