...
void init_tmx_tile_layer_py_auto(py::module &_tmx, Registry &registry) {
    py::class_<tmx::TileLayer, tmx::Layer> _TileLayer(_tmx, "TileLayer");
    registry.on(_tmx, "TileLayer", _TileLayer);
        py::class_<tmx::TileLayer::Tile> _TileLayerTile(_tmx, "TileLayerTile");
        registry.on(_tmx, "TileLayerTile", _TileLayerTile);
            _TileLayerTile
            .def_readwrite("id", &tmx::TileLayer::Tile::ID)
            .def_readwrite("flip_flags", &tmx::TileLayer::Tile::flipFlags)
        ;

        py::class_<tmx::TileLayer::Chunk> _TileLayerChunk(_tmx, "TileLayerChunk");
        registry.on(_tmx, "TileLayerChunk", _TileLayerChunk);
            _TileLayerChunk
        ...
        py::enum_<tmx::TileLayer::FlipFlag>(_TileLayer, "FlipFlag", py::arithmetic())
