...
class Scene(Base, Generic[T_Node]):
    def __init__(self) -> None:
        ...
        self.layers: List[GraphLayer[T_Node]] = []
        self.layers_by_name: Dict[str, GraphLayer[T_Node]] = {}
    ...
    def add_layer(self, layer: GraphLayer[T_Node]):
        layer.scene = self
    ...
    def remove_layer(self, layer: GraphLayer[T_Node]):
