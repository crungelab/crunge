...
class PhysicsGroup2D(PhysicsModel2D):
    ...
    def __init__(self, position=glm.vec2(), physics=physics.GroupPhysics, geom=geom.GroupGeom):
...
class DynamicModel2D(PhysicsModel2D):
    def __init__(self, position=glm.vec2(), vu=None, brain=None, physics=physics.DynamicPhysics, geom=geom.HullGeom):
        super().__init__(position, vu, brain, physics, geom)
        '''
...
class KinematicModel(PhysicsModel2D):
    def __init__(self, position=glm.vec2(), vu=None, brain=None, physics=physics.KinematicPhysics, geom=geom.HullGeom):
        super().__init__(position, vu, brain, physics, geom)
