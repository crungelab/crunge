from crunge.abt.compile.compilerbase import CompilerBase
#from crunge.abt.compile.policies.default import DefaultPolicy
import crunge.abt.compile.ast.node as yy
