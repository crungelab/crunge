...
void init_generated(py::module &_implot, Registry &registry) {
    ...
    Flags
        ...
        .value("FLAGS_NO_CHILD", ImPlotFlags_::ImPlotFlags_NoChild)
    ...
    _implot.def("drag_point", [](int id, double * x, double * y, const ImVec4 & col, float size, ImPlotDragToolFlags flags)
    {
    ...
    _implot.def("drag_line_x", [](int id, double * x, const ImVec4 & col, float thickness, ImPlotDragToolFlags flags)
    {
    ...
    _implot.def("drag_line_y", [](int id, double * y, const ImVec4 & col, float thickness, ImPlotDragToolFlags flags)
    {
    ...
    _implot.def("drag_rect", [](int id, double * x1, double * y1, double * x2, double * y2, const ImVec4 & col, ImPlotDragToolFlags flags)
    {
