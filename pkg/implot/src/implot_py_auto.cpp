...
void init_generated(py::module &_implot, Registry &registry) {
    ...
    .def("destroy_context", [](py::capsule ctx)
        {
            return ImPlot::DestroyContext(static_cast<ImPlotContext *>(ctx.get_pointer()));
        }
        , py::arg("ctx") = nullptr
        )
    .def("get_current_context", []()
        {
            return py::capsule(ImPlot::GetCurrentContext(), "ImPlotContext");
        }
        )
    .def("set_current_context", [](py::capsule ctx)
        {
            return ImPlot::SetCurrentContext(static_cast<ImPlotContext *>(ctx.get_pointer()));
        }
        , py::arg("ctx")
        )
    .def("set_im_gui_context", [](py::capsule ctx)
        {
            return ImPlot::SetImGuiContext(static_cast<ImGuiContext *>(ctx.get_pointer()));
        }
        , py::arg("ctx")
        )
    ...
    .def("begin_subplots", [](const char * title_id, int rows, int cols, const ImVec2 & size, ImPlotSubplotFlags flags, float * row_ratios, float * col_ratios)
        {
            auto _ret = ImPlot::BeginSubplots(title_id, rows, cols, size, flags, row_ratios, col_ratios);
            return std::make_tuple(_ret, row_ratios, col_ratios);
        }
        , py::arg("title_id")
        , py::arg("rows")
        , py::arg("cols")
    ...
    .def("setup_axis_format", py::overload_cast<ImAxis, int (*)(double, char *, int, void *), void *>(&ImPlot::SetupAxisFormat)
        , py::arg("axis")
        , py::arg("formatter")
        , py::arg("data") = nullptr
        )
    ...
    .def("setup_axis_scale", py::overload_cast<ImAxis, double (*)(double, void *), double (*)(double, void *), void *>(&ImPlot::SetupAxisScale)
        , py::arg("axis")
        , py::arg("forward")
        , py::arg("inverse")
        , py::arg("data") = nullptr
    ...
    .def("drag_point", [](int id, double * x, double * y, const ImVec4 & col, float size, ImPlotDragToolFlags flags, bool * out_clicked, bool * out_hovered, bool * held)
        {
            auto _ret = ImPlot::DragPoint(id, x, y, col, size, flags, out_clicked, out_hovered, held);
            return std::make_tuple(_ret, x, y, out_clicked, out_hovered, held);
        }
        , py::arg("id")
        , py::arg("x")
        , py::arg("y")
    ...
    .def("drag_line_x", [](int id, double * x, const ImVec4 & col, float thickness, ImPlotDragToolFlags flags, bool * out_clicked, bool * out_hovered, bool * held)
        {
            auto _ret = ImPlot::DragLineX(id, x, col, thickness, flags, out_clicked, out_hovered, held);
            return std::make_tuple(_ret, x, out_clicked, out_hovered, held);
        }
        , py::arg("id")
        , py::arg("x")
        , py::arg("col")
    ...
    .def("drag_line_y", [](int id, double * y, const ImVec4 & col, float thickness, ImPlotDragToolFlags flags, bool * out_clicked, bool * out_hovered, bool * held)
        {
            auto _ret = ImPlot::DragLineY(id, y, col, thickness, flags, out_clicked, out_hovered, held);
            return std::make_tuple(_ret, y, out_clicked, out_hovered, held);
        }
        , py::arg("id")
        , py::arg("y")
        , py::arg("col")
    ...
    .def("drag_rect", [](int id, double * x1, double * y1, double * x2, double * y2, const ImVec4 & col, ImPlotDragToolFlags flags, bool * out_clicked, bool * out_hovered, bool * held)
        {
            auto _ret = ImPlot::DragRect(id, x1, y1, x2, y2, col, flags, out_clicked, out_hovered, held);
            return std::make_tuple(_ret, x1, y1, x2, y2, out_clicked, out_hovered, held);
        }
        , py::arg("id")
        , py::arg("x1")
        , py::arg("y1")
    ...
    .def("annotation", [](double x, double y, const ImVec4 & col, const ImVec2 & pix_offset, bool clamp, const char * fmt)
        {
            return ImPlot::Annotation(x, y, col, pix_offset, clamp, fmt);
        }
        , py::arg("x")
        , py::arg("y")
        , py::arg("col")
    ...
    .def("colormap_slider", [](const char * label, float * t, ImVec4 * out, const char * format, ImPlotColormap cmap)
        {
            auto _ret = ImPlot::ColormapSlider(label, t, out, format, cmap);
            return std::make_tuple(_ret, t);
        }
        , py::arg("label")
        , py::arg("t")
        , py::arg("out") = nullptr
